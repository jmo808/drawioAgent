"""Content filter scanning content for sensitive data before sending to cloud."""
...
class ContentFilter:
    ...
    HOSTNAME_PATTERN = re.compile(
        ...
        r'(?:local|internal|corp|lan|localdomain|dev)\b|localhost',
        re.IGNORECASE
    )
    
    # Credential/secret patterns
    CREDENTIAL_PATTERN = re.compile(
        r'\b[a-zA-Z0-9_]*(?:password|passwd|api_key|apikey|secret|'
        r'token|private_key|aws_access_key_id|aws_secret_access_key)'
